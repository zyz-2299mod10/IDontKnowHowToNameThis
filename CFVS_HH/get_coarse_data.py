...
for i in range(num_envs):
    ...
    hole_top_pose.p = gymapi.Vec3(usb_place_pose.p.x, usb_place_pose.p.y, usb_place_pose.p.z + 0.023)
...
while not gym.query_viewer_has_closed(viewer):    
    ...
    if IsGrasp.all():
        ...
        for env in range(num_envs):
            ...
            # Following staff are useless in coarse part. I tried to reduce the redundant, but his way to construct dataset it's too annoying... so it will keep erroring if I do so. 
